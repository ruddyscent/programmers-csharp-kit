...
Dictionary<string, List<Song>> songsByGenre
```

`Song`에는 다음 정보를 저장합니다.
...
public class Solution
{
    public int[] solution(string[] genres, int[] plays)
    {
        ...
        Dictionary<string, List<Song>> songsByGenre = new Dictionary<string, List<Song>>();
        ...
        for (int i = 0; i < genres.Length; i++)
        {
            ...
            {
                genreTotal[genre] = 0;
                songsByGenre[genre] = new List<Song>();
            }

            genreTotal[genre] += play;
            songsByGenre[genre].Add(new Song(i, play));
        }
        ...
        {
            var selectedSongs = songsByGenre[genre]
...
# 🚀 풀이 2. 코드가 짧은 방법 — LINQ GroupBy 활용하기
...
public class Solution
{
    public int[] solution(string[] genres, int[] plays)
    {
        return genres
            ...
            .OrderByDescending(group => group.Sum(song => song.Play))
