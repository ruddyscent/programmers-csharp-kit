...
public class Solution
{
    public int solution(int[,] jobs)
    {
        ...
        var pq = new PriorityQueue<Job, (int length, int start, int index)>();
    ...
    public class Job
    {
        ...
        public Job(int index, int start, int length)
        {
            Index = index;
            Start = start;
            Length = length;
...
# 🚀 풀이 2. 코드가 짧은 방법 — LINQ + PriorityQueue
...
|---|---|---|---:|---:|
| 풀이 1 | 클래스 + PriorityQueue | 흐름이 명확하다 😊 | O(n log n) | O(n) |
